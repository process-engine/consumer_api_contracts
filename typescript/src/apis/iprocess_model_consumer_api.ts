...
export interface IProcessModelConsumerApi {
   ...
   *                             found.
   */
  getProcessResultForCorrelation(identity: IIdentity, correlationId: string, processModelId: string): Promise<DataModels.CorrelationResultList>;
   ...
   *                             valid auth token.
   */
  getProcessInstancesByIdentity(identity: IIdentity, offset?: number, limit?: number): Promise<DataModels.ProcessInstanceList>;
